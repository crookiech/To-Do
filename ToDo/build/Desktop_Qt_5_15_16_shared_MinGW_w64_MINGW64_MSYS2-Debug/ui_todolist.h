...
public:
    ...
    void setupUi(QDialog *ToDoList)
    {
        ...
        ToDoList->setStyleSheet(QString::fromUtf8("#ToDoList{\n"
"background-color: #333F51;}\n"
""));
        gridLayout_2 = new QGridLayout(ToDoList);
...
"border-radius: 8px;"));
        ...
        calendar_button = new QPushButton(ToDoList);
...
"color: #950505;"));
    ...
    {
        ToDoList->setWindowTitle(QCoreApplication::translate("ToDoList", "To Do", nullptr));
        add_task->setText(QString());
        edit_task->setText(QString());
        delete_task->setText(QString());
        calendar_button->setText(QCoreApplication::translate("ToDoList", "\320\272\320\260\320\273\320\265\320\275\320\264\320\260\321\200\321\214", nullptr));
        label_date->setText(QCoreApplication::translate("ToDoList", "<html><head/><body><p align=\"center\"><span style=\" font-weight:700;\">05.04.2025</span></p></body></html>", nullptr));
    } // retranslateUi
